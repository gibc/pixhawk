...
// gib - decode aircraft adsb frame
// gib - frame looks like array of 18 raw values corrected by fec but what of 34 byte frame?????
// gib - these are interpreted into uat_adsb_mdb struct
...
// gib - decode longer 34 byte frame mode status frame
...
void uat_decode_adsb_mdb(uint8_t *frame, struct uat_adsb_mdb *mdb)
{
    ...
    *mdb = mdb_zero;
    ...
    case 10: // HDR SV reserved
        uat_decode_sv(frame, mdb); // gib - decode down link frame
        break;
...
// gib - display parts of adsb decode struct
...
// gib - main entry point to decode uplink frame
