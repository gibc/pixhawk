...
def mag_heading(RAW_IMU, ATTITUDE, declination=None, SENSOR_OFFSETS=None, ofs=None, s_factor=None):
    ...
    if s_factor != None:
        headX = lowpass(headX,'headX', s_factor)
        headY = lowpass(headY,'headY', s_factor)
